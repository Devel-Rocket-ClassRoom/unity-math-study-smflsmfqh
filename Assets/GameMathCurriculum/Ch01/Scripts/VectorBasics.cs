...
public class VectorBasics : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 vectorB = new Vector3(1f, 0f, 3f); // private인데도 인스펙터에서 수정 가능하도록 SerializeField 속성 사용
    ...
    private void OnValidate() // 유니티 이벤트 함수, 인스펙터의 값들이 갱신됐을 때 호출됨, 플레이하지 않아도 에디터에서 실행됨
    {
        PrintVectorOperations();
    }
