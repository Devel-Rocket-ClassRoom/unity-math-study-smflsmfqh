...
public class Assignment_UIPopup : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.Space)) // 토글
        {
    ...
    private void UpdateAnimation()
    {
        ...
        {
            // TODO, EaseOut 적용
            Debug.Log($"[Showing] t: {t:F2}, EaseOut(t): {EaseOut(t):F2}");
        ...
        else if (currentState == PopupState.Hiding)
        {
            ...
            Vector3 newScale = popupPanel.localScale;
            newScale = Vector3.one * EaseIn(1f-t);
            popupPanel.localScale = newScale;
